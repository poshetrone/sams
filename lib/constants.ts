...
export const NAV: NavGroup[] = [
  ...
  { group: 'Administration', items: [
    ...
    { key: 'inactivite', label: 'Suivi pointage',    icon: 'alert',     route: '/inactivite', admin: true },
...
export const PAGE_META: Record<string, { title: string; sub: string }> = {
  ...
  inactivite:   { title: 'Suivi du pointage', sub: 'Qui n’a pas pris son service depuis longtemps' },
